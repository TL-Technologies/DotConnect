    ...
    **/
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        void Start()
        {
            ...
            Invoke("InitializeTimer",1f);
        
        }

        public void StartTimerOnDailyRewardBtnClick() 
        {
            InitializeTimer();
        }
        ...
        public void ClaimPrize()
        {
            if (availableReward > 0)
            {
                ...
                Debug.LogWarning(" Reward [" + rewards[availableReward - 1].reward + "] Claimed! : " + availableReward);
                GameBug.DotConnect.GameManager.Instance.GiveHints(rewards[availableReward - 1].reward);
