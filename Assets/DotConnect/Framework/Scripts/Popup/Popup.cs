...
namespace GameBug
{
	public class Popup : UIMonoBehaviour
	{
		...
		public virtual void OnHiding()
		{
			...
			GameBug.DotConnect.GameManager.Instance.Particles.SetActive(false);
			GameBug.DotConnect.GameManager.Instance.mainCanvas.renderMode = RenderMode.ScreenSpaceOverlay;
		}
