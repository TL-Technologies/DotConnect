	...
	public class BundleScreen : Screen
	{
		...
		public override void Initialize()
		{
			...
			for (int i = 0; i < GameManager.Instance.BundleInfos.Count; i++)
			{
				...
				bundleInfo.PackListItemPrefab.gameObject.GetComponent<RectTransform>().sizeDelta = new Vector2(0, 240);
			}
		...
		private void OnPackItemSelected(int index, object data)
		{
			...
			PlayerPrefs.SetInt("PreviousSelectedBundle",packInfo.Count);
		}
